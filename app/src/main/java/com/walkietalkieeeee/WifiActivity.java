...
public abstract class WifiActivity extends Activity {
    ...
    private String getMacAddress() {
        WifiManager wifiMan = (WifiManager) this.getApplicationContext()
    ...
    private void setupService() {
        ...
        mServiceInfo = WifiP2pDnsSdServiceInfo.newInstance(getMacAddress(), SERVICE_NAME, record);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mChannel = mManager.initialize(WifiActivity.this, getMainLooper(), null);
        mReceiver = new WiFiDirectBroadcastReceiver(mManager, mChannel, WifiActivity.this);
    ...
    private void broadcastData(byte[] data) {
        ...
        Log.d(LOGTAG, String.valueOf(state.getClientAddresses()));
    ...
    private void setupServiceListeners() {
        ...
        WifiP2pManager.DnsSdServiceResponseListener servListener = new WifiP2pManager.DnsSdServiceResponseListener() {
            ...
            public void onDnsSdServiceAvailable(String instanceName, String registrationType, WifiP2pDevice device) {
                ...
                ConnectionState.Buddy b = state.getBuddy(device.deviceAddress);
    ...
    private void manageConnection() {
        ...
        if (state.connected()) {
            ...
            for (ConnectionState.Buddy b : state.findSingleBuddies()) {
            ...
            if (state.haveGroupOwner()) {
                ...
                ConnectionState.Buddy b = state.findBuddyToConnect();
